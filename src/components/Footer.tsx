      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          <div>
            ...
            <p className="text-foreground/70 text-sm leading-relaxed mb-6">
              Suncity Projects Pvt. Ltd. is one of India's leading real estate
              developers, known for creating premium residential and commercial
              spaces across major cities. With a vision to design modern,
              sustainable, and high-quality developments, Suncity Developer has
              earned a strong reputation for trust, innovation, and excellence
        ...
        <div className="border-t border-border/30 pt-8 space-y-4">
          ...
          <p className="text-xs text-foreground/50 leading-relaxed">
            ...
            This website belongs to authorized marketing partner.
          </p>
